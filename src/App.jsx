...
export default function App() {
  ...
  const agregarEventos = (nuevos) => {
    ...
    const eventosUnicos = nuevos.filter(nuevo => 
      !eventosActuales.some(existente => 
    ...
    <div className="flex flex-col">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6 rounded-b-3xl shadow-lg mb-8">
        <div className="container mx-auto">
          <h1 className="text-2xl font-bold text-white mb-6 text-center">Generador de Horarios</h1>
      ...
      <div className="flex w-full place-content-center">
        {codigoMateria && (
          <SelectorParalelos
            ...
            nombreMateria={FiecMallas.Fiec[carreraSeleccionada].materias.find(m => m.codigo === codigoMateria)?.Materia || codigoMateria}
          />
        )}
      </div>
